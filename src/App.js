...
class App extends React.Component {
  state = {
    ...
    panier: [],
    articles: [
      { produit: "Coca Cola", prix: 1, stock: 5, image: '../../img/coke.jpg'},
      { produit: "Fanta", prix: 1.50, stock: 5, image: '../../img/fanta-grape.png'},
      { produit: "Ice tea", prix: 2, stock: 5, image: '../../img/welch-grape.png'},
    ]
  };
